...
zokou({
  ...
  respond("◆━━━━━━✦FACT✦━━━━━━◆ \n*◇* " + factData.fact + "\n\n\n\n\n*◇* Engine by *IMMORTAL DRAGON*\n\n╔═════◇\n║◇ *KEEP USING IMMORTAL DRAGON*\n╚════════════════════> ");
});
...
zokou({
  ...
  try {
    ...
    const lyricsMessage = "*IMMORTAL DRAGON LYRICS FINDER*\n\n*TITLE* - " + title + "\n\n*ARTIST* - " + artist + "\n\n" + lyrics;
    await sender.sendMessage(message, {
      'image': {
